...
# Q3. 福岡県の 平均気温を計算してください(14.0となればOK)
    fukuoka_stations = [info["temperature"] for info in weather_information if info["prefecture"] == "福岡県"]
    print(sum(fukuoka_stations) / len(fukuoka_stations))
